IR dumped to ./test14.ll
24 : foo
31 : foo, clever
32 : plus
clr@5793bd35fba7~/use-def/build $ cat test14.ll
; ModuleID = './test14.bc'
source_filename = "/home/clr/use-def/assign2-tests/test14.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @moo(i8 noundef signext %0, i32 noundef %1, i32 noundef %2) #0 !dbg !46 {
    #dbg_value(i8 %0, !50, !DIExpression(), !51)
    #dbg_value(i32 %1, !52, !DIExpression(), !51)
    #dbg_value(i32 %2, !53, !DIExpression(), !51)
    #dbg_value(ptr @plus, !54, !DIExpression(), !51)
    #dbg_value(ptr @minus, !55, !DIExpression(), !51)
    #dbg_value(ptr @foo, !56, !DIExpression(), !51)
    #dbg_value(ptr null, !58, !DIExpression(), !51)
  %4 = sext i8 %0 to i32, !dbg !59
  %5 = icmp eq i32 %4, 43, !dbg !61
  br i1 %5, label %6, label %8, !dbg !61

6:                                                ; preds = %3
  %7 = call ptr @foo(i32 noundef %1, i32 noundef %2, ptr noundef @plus, ptr noundef @minus), !dbg !62
    #dbg_value(ptr %7, !58, !DIExpression(), !51)
    #dbg_value(ptr @plus, !55, !DIExpression(), !51)
  br label %9, !dbg !64

8:                                                ; preds = %3
    #dbg_value(ptr @clever, !56, !DIExpression(), !51)
  br label %9

9:                                                ; preds = %8, %6
  %.01 = phi ptr [ @plus, %6 ], [ @minus, %8 ], !dbg !51
  %.0 = phi ptr [ @foo, %6 ], [ @clever, %8 ], !dbg !51
    #dbg_value(ptr %.0, !56, !DIExpression(), !51)
    #dbg_value(ptr %.01, !55, !DIExpression(), !51)
  %10 = call ptr %.0(i32 noundef %1, i32 noundef %2, ptr noundef %.01, ptr noundef @plus), !dbg !65
    #dbg_value(ptr %10, !58, !DIExpression(), !51)
  %11 = call i32 %10(i32 noundef %1, i32 noundef %2), !dbg !66
  ret i32 0, !dbg !67
}
...
!1 = !DIFile(filename: "/home/clr/use-def/assign2-tests/test14.c", directory: "/home/clr/use-def/build", checksumkind: CSK_MD5, checksum: "d84df2316933434ae68e72a1fb2f58d6")
...
!13 = !DIFile(filename: "assign2-tests/test14.c", directory: "/home/clr/use-def", checksumkind: CSK_MD5, checksum: "d84df2316933434ae68e72a1fb2f58d6")
...
!45 = !DILocation(line: 14, column: 4, scope: !39)
!46 = distinct !DISubprogram(name: "moo", scope: !13, file: !13, line: 16, type: !47, scopeLine: 16, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !17)
!47 = !DISubroutineType(types: !48)
!48 = !{!16, !49, !16, !16}
!49 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!50 = !DILocalVariable(name: "x", arg: 1, scope: !46, file: !13, line: 16, type: !49)
!51 = !DILocation(line: 0, scope: !46)
!52 = !DILocalVariable(name: "op1", arg: 2, scope: !46, file: !13, line: 16, type: !16)
!53 = !DILocalVariable(name: "op2", arg: 3, scope: !46, file: !13, line: 16, type: !16)
!54 = !DILocalVariable(name: "a_fptr", scope: !46, file: !13, line: 17, type: !32)
!55 = !DILocalVariable(name: "s_fptr", scope: !46, file: !13, line: 18, type: !32)
!56 = !DILocalVariable(name: "goo_ptr", scope: !46, file: !13, line: 19, type: !57)
!57 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !30, size: 64)
!58 = !DILocalVariable(name: "t_fptr", scope: !46, file: !13, line: 20, type: !32)
!59 = !DILocation(line: 22, column: 8, scope: !60)
!60 = distinct !DILexicalBlock(scope: !46, file: !13, line: 22, column: 8)
!61 = !DILocation(line: 22, column: 10, scope: !60)
!62 = !DILocation(line: 24, column: 18, scope: !63)
!63 = distinct !DILexicalBlock(scope: !60, file: !13, line: 23, column: 5)
!64 = !DILocation(line: 26, column: 5, scope: !63)
!65 = !DILocation(line: 31, column: 14, scope: !46)
!66 = !DILocation(line: 32, column: 5, scope: !46)
!67 = !DILocation(line: 34, column: 5, scope: !46)